...
// is the id of the canvas element on the html page.
    ...
    c3dl.addModel("bundles/minedochome/js/canvas3d/duck.dae");
    var duck;
...
function canvasMain(canvasName) {
    ...
    if (scn.init(canvasName)) {
        for (var i = 0; i < 4; i++) {
            ...
            things[i].init("bundles/minedochome/js/canvas3d/duck.dae");
            things[i].scale(new Array(0.2, 0.2, 0.2));
            things[i].setTexture("bundles/minedochome/js/canvas3d/duck.png");
