...
class appProdDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MineDocChatBundle', '/var/www/Symfony/app/Resources/MineDocChatBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MineDocChatBundle', '/var/www/Symfony/src/MineDoc/ChatBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MineDocLayoutBundle', '/var/www/Symfony/app/Resources/MineDocLayoutBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MineDocLayoutBundle', '/var/www/Symfony/src/MineDoc/LayoutBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MineDocHomeBundle', '/var/www/Symfony/app/Resources/MineDocHomeBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MineDocHomeBundle', '/var/www/Symfony/src/MineDoc/HomeBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MineDocModelsBundle', '/var/www/Symfony/app/Resources/MineDocModelsBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MineDocModelsBundle', '/var/www/Symfony/src/MineDoc/ModelsBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    /**
     * Gets the 'command_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return MineDoc\HomeBundle\Manager\CommandManager A MineDoc\HomeBundle\Manager\CommandManager instance.
     */
    protected function getCommandManagerService()
    {
        return $this->services['command_manager'] = new \MineDoc\HomeBundle\Manager\CommandManager($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'symfony', 'host' => '127.0.0.1', 'port' => '', 'user' => 'root', 'password' => 'econolol', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $a, $b, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(new \Symfony\Bridge\Doctrine\Annotations\IndexedReader($this->get('annotation_reader')), array(0 => '/var/www/Symfony/src/MineDoc/HomeBundle/Entity')), 'MineDoc\\HomeBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('MineDocHomeBundle' => 'MineDoc\\HomeBundle\\Entity'));
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '716074a42b809629d6a0d2bcc640f41e07392bde');
    }
    ...
    /**
     * Gets the 'mc_server' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return MineDoc\HomeBundle\Service\MinecraftCommands A MineDoc\HomeBundle\Service\MinecraftCommands instance.
     */
    protected function getMcServerService()
    {
        return $this->services['mc_server'] = new \MineDoc\HomeBundle\Service\MinecraftCommands();
    }
    ...
    protected function getSwiftmailer_TransportService()
    {
        ...
        $instance->setUsername('noreply.docserver@gmail.com');
        $instance->setPassword('doccobraserver$');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MineDocChatBundle' => 'MineDoc\\ChatBundle\\MineDocChatBundle',
                'MineDocLayoutBundle' => 'MineDoc\\LayoutBundle\\MineDocLayoutBundle',
                'MineDocHomeBundle' => 'MineDoc\\HomeBundle\\MineDocHomeBundle',
                'MineDocModelsBundle' => 'MineDoc\\ModelsBundle\\MineDocModelsBundle',
            ),
            ...
            'database_user' => 'root',
            'database_password' => 'econolol',
            'mailer_transport' => 'gmail',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'noreply.docserver@gmail.com',
            'mailer_password' => 'doccobraserver$',
            'locale' => 'fr',
            'secret' => '716074a42b809629d6a0d2bcc640f41e07392bde',
            ...
            'kernel.secret' => '716074a42b809629d6a0d2bcc640f41e07392bde',
            ...
            'swiftmailer.transport.smtp.username' => 'noreply.docserver@gmail.com',
            'swiftmailer.transport.smtp.password' => 'doccobraserver$',
            ...
            'assetic.bundles' => array(
                ...
                9 => 'MineDocChatBundle',
                10 => 'MineDocLayoutBundle',
                11 => 'MineDocHomeBundle',
                12 => 'MineDocModelsBundle',
            ),
            ...
            'mc_server.class' => 'MineDoc\\HomeBundle\\Service\\MinecraftCommands',
            'command_manager.class' => 'MineDoc\\HomeBundle\\Manager\\CommandManager',
        );
    }
}
